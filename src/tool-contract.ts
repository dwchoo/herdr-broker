...
export const brokerTools = {
  ...
  action_propose: { annotations: change, description: 'Fix an immutable Action proposal including wrapper and Enter. Does not submit input.', inputSchema: proposalSchema },

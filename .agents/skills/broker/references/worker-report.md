...
Startup length modes bound narrative and original evidence separately. Medium retains 1000/3000 characters; short halves and long doubles those budgets. Auto selects medium or long in a single independent turn. Inspect response_length_used, partial and omitted_evidence; changing length does not widen capture or add model calls.
